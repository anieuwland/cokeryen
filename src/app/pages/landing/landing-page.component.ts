...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule, BookTeaserComponent, BookTeasersComponent, RecipeTeaserComponent, ToolbarComponent, PageContainerComponent, RecipesOverviewComponent, RecipeImageUrlPipe, RecipeUrlPipe, ResponsiveColumn],
